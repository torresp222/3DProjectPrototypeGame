...
public class AbilitiesCaptureHUD : MonoBehaviour 
{
    ...
    public void AbilityMove() {
        ...
        _playerSpirithar.PerformMove(_spiritharMove, 0, _enemySpirithar); // On click del button hace el performove del spirithar (algo así hay que darle alguna vuelta)
        // Luego manejar los estados de los turnos ESO SI QUE SI EN EL COMBAT MANAGER.
    }
}
